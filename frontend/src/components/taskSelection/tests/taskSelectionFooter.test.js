...
import { MappingTypeIcon, TaskSelectionFooter, Imagery } from '../index';
...
it('test if footer has MappingTypeIcon component defined set with the correct mappingTypes', () => {
  const element = createComponentWithIntl(<TaskSelectionFooter mappingTypes={['ROADS', 'BUILDINGS']}/>);
  const testInstance = element.root;
  expect(
    testInstance.findAllByType(MappingTypeIcon).map(i => i.props.type)
