...
class UserInformationForm extends React.Component {
  ...
  render() {
    ...
    const fieldClasses = 'blue-grey w-100 mr3 pv3 ph2 input-reset ba b--grey-light bg-transparent';
    return (
            ...
            return (
              <form onSubmit={handleSubmit} className="blue-grey">
                ...
                <div>
                  ...
                  <Field name="emailAddress" component="input" className={fieldClasses} />
                </div>
                <div>
                  <label className={labelClasses}>
